...
public class metodos {
    ...
    public void PersistenciadatosAlmacenamiento(PilaRuta pr){
    ...
    // Obtencion de datos
    public void PersistenciaObtencionDatos(){
    ...
    public Bus[] cargarBus(String direccion){
        Bus bus[] = null;
        Asiento[] Vas = null;
    ...
    public Asiento[] cargarAsiento(String direccion){
    ...
    public DatosPersonal[] cargarPersonal(String direccion){
    ...
    //obtencion de Parada
    public Parada[] cargarParada(String direccion){
        int indice = 0;
        Parada[] P = null;
            System.out.println("**************************************");
    ...
    public Horario[] cargarHorario(String direccion){
        Horario[] H = null;
    ...
    //obtener tarifa
    public Tarifa[] cargarTarifa(String direccion){
        Tarifa[] T = null;
        int indice = 0;
        int j = 0;
    ...
    //generar Cantridad Asientos
    public Asiento[] generarAsientos(){
    ...
    public void Manipular(PilaRuta pr){
